...
/**
 * Created on 17/6/7. 短信API产品的DEMO程序,工程中包含了一个SendSmsUtils类，直接通过
...
public class SendSmsUtils {
     ...
     */
    static final String ACCESSKEY_ID = "LTAIoI09peWpzI8R";
    static final String ACCESSKEY_SECRET = "ePDiL8r1VyPVnFi7jzBxR8G6CS5Xd8";
    ...
    public static SendSmsResponse sendSms(String phoneNumber, String smsCode) throws ClientException {
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("王涛");
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_136165408");
